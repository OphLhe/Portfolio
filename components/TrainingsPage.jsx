...
const TrainingsPage = () => {
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="mt-16 flex flex-col items-center justify-center pb-30">
        <AnimatedContent
          className="mx-auto max-w-6xl pt-15 pb-15 text-center text-xl font-bold md:pb-0 md:text-3xl/12"
          distance={0}
          direction="vertical"
          reverse
          duration={2}
